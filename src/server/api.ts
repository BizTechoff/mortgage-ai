...
export const entities = [User, WhatsAppConversation, ChangeLog, MortgageRequest, Document, Appointment, Stage, MortgageRequestStage]
export const controllers = [SignInController, UpdatePasswordController, RequestController,
  UserController, OperatorController, RequestController, AppointmentController]
...
/*    
        ...
        `
            ...
            if (result && result.rows && result.rows.length > 0) {
                ...
                console.log('request_requestNumber_seq', count)
